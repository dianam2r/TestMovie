...
include(FCPATH."/application/models/Movie.php");
include(FCPATH."/application/models/Person.php");
include(FCPATH."/application/models/Role.php");
include(FCPATH."/application/models/roles/MovieRole.php");
include(FCPATH."/application/models/roles/TVShowRole.php");

class TMDB {

        const defaultApikey = "d11686dd998da506bd15580110f2d5da";
	 ...
	 */
	public function __construct($apikey = null, $lang = 'en', $debug = false) {
	 ...
	 * 	@return Movie[]
        ...
        public function searchMulti($searchCriteria){

		$criteria = array();

		$result = $this->_call('search/multi', 'query='. urlencode($searchCriteria), $this->getLang());

		foreach($result['results'] as $data){
			$criteria[] = new Movie($data);
		}
